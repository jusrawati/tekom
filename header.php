...
<head>
    <title>Teknik Komputer - S1</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <!-- favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/x-icon/logounm.png">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-3 col-12">
                    <div class="mobile-menu-wrapper d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div class="logo">
                            <a href="index.php">
                                <img src="assets/images/logo/logojtik.png" alt="logo">
                            </a>
                        </div>
                        ...
                        <div class="header-wrapper">
                            <div class="menu-area justify-content-between w-100">
                                <ul class="menu lab-ul">
                                    ...
                                    <li>
                                        <a href="#tentang">Tentang Program Studi</a>
                                    </li>
                                    <li>
