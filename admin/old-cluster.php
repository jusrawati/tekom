    ...
    if (isset($_POST['set']))
    {
        ...
        $koneksi->query("UPDATE tb_clustering set c1 ='$_POST[c1_5]', c2='$_POST[c2_4]', c3='$_POST[c3_4]' where id_kriteria='5'");
        $koneksi->query("UPDATE tb_clustering set c1 ='$_POST[c1_6]', c2='$_POST[c2_4]', c3='$_POST[c3_4]' where id_kriteria='6'");
        $koneksi->query("UPDATE tb_clustering set c1 ='$_POST[c1_7]', c2='$_POST[c2_4]', c3='$_POST[c3_4]' where id_kriteria='7'");
        $koneksi->query("UPDATE tb_clustering set c1 ='$_POST[c1_8]', c2='$_POST[c2_4]', c3='$_POST[c3_4]' where id_kriteria='8'");
        $koneksi->query("UPDATE tb_clustering set c1 ='$_POST[c1_9]', c2='$_POST[c2_4]', c3='$_POST[c3_4]' where id_kriteria='9'");
