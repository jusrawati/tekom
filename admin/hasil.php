...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Pembagian Konsentrasi Mahasiswa</h1>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-success">Data Pembagian Konsentrasi Mahasiswa 
                            &emsp; 
                    ...
                    <div class="card-body">
                     <ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
                        <li class="nav-item "><a class="nav-link show active" href="#solid-rounded-justified-a" data-toggle="tab">Konsentrasi Embedded System
                            <li class="nav-item"><a class="nav-link" href="#solid-rounded-justified-b" data-toggle="tab">Konsentrasi Jaringan dan Forensik
                               <li class="nav-item"><a class="nav-link" href="#solid-rounded-justified-c" data-toggle="tab">Konsentrasi Sistem Cerdas
                               </ul>
                               <div class="tab-content">
                                <div class="tab-pane show active" id="solid-rounded-justified-a">
                                    <div class="table-responsive">
                                        <center><h3>Data Mahasiswa Konsentrasi Embedded System</h3></center>
                                        <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                             <?php $nomor=1;
                                             $ambil=$koneksi->query("SELECT * FROM tb_hasil_clustering_2 where cluster='A'");
                        ...
                        <div class="tab-pane" id="solid-rounded-justified-b">
                            <div class="table-responsive">
                               <center><h3>Data Mahasiswa Konsentrasi Jaringan dan Forensik</h3></center>
                               <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                ...
                                <tbody>
                                 <?php $nomor=1;
                                 $ambil=$koneksi->query("SELECT * FROM tb_hasil_clustering_2 where cluster='B'");
                                 while ($data=$ambil->fetch_array()){
            ...
            <div class="tab-pane" id="solid-rounded-justified-c">
                <div class="table-responsive">
                  <center><h3>Data Mahasiswa Konsentrasi Sistem Cerdas</h3></center>
                  <table class="table table-bordered" id="" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No</th>
                    ...
                    <tbody>
                     <?php $nomor=1;
                     $ambil=$koneksi->query("SELECT * FROM tb_hasil_clustering_2 where cluster='C'");
                     while ($data=$ambil->fetch_array()){
...
<div class="modal-dialog" role="document">
   <div class="modal-content">
       <div class="modal-header">
           <h5 class="modal-title" id="exampleModalLabel">Cetak Data Konsentrasi Mahasiswa</h5>
           <button class="close" type="button" data-dismiss="modal" aria-label="Close">
               <span aria-hidden="true">×</span>
           </button>
       </div>
       <div class="modal-body">
        <form class="user"  method="post">
            <div class="form-group">                  
                <label>Pilih Konsentrasi</label>
                <select name="Konsentrasi" class="form-control">
                    <option value="all">SEMUA</option>
                    <option value="a">Konsentrasi A</option>
                    <option value="b">Konsentrasi B</option>
                    <option value="c">Konsentrasi C</option>
                </select>
            </div>
            <button class="btn btn-success" name="cetak">Cetak Sekarang</button>
        </form>
        <?php if (isset($_POST['cetak'])) {
            echo "<meta http-equiv='refresh' content='1;url=cetak.php?id=$_POST[Konsentrasi]'>";
        } ?>
...
if (isset($_POST['simpan']))
{
    ...
    $koneksi->query("INSERT INTO tb_mahasiswa_2
        (nama_mahasiswa,tempat_lahir,tanggal_lahir,alamat,no_hp) 
